    ...
    return (
        <form className="md:col-span-7 flex flex-col gap-5 text-xs font-medium text-white/90 ">
            ...
            <div className="flex justify-center mt-4">
                <button type="submit" className="bg-white text-black font-normal tracking-wider px-10 py-3 rounded-lg shadow-md hover:bg-black hover:text-white border border-white/40 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 text-sm">
                    Send
                </button>
            </div>
